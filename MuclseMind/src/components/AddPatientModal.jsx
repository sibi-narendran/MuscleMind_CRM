...
import { Modal, Input, Select, Form, Button, Upload, Row, Col, Radio, Drawer } from "antd";
...
const AddPatientModal = ({ visible, onClose, onAdd }) => {
  ...
  const [showCaseSheetForm, setShowCaseSheetForm] = useState(false);
  ...
  const handleOpenCaseSheetForm = () => {
    setShowCaseSheetForm(true);
  };

  const handleCloseCaseSheetForm = () => {
    setShowCaseSheetForm(false);
  };
  ...
  return (
    <>
        ...
        >
          ...
          <Form.Item label="Case Sheet">
            <Row gutter={16}>
              ...
              <Col span={12}>
                <Button type="default" onClick={handleOpenCaseSheetForm}>
                  Fill Case Sheet Form
                </Button>
              </Col>
            </Row>
          </Form.Item>
      ...
      <Drawer
        title="Case Sheet Form"
        placement="right"
        onClose={handleCloseCaseSheetForm}
        visible={showCaseSheetForm}
        width={400}
      >
        <Form layout="vertical">
          ...
          <Button type="primary" onClick={handleCloseCaseSheetForm}>
            Submit
          </Button>
        </Form>
      </Drawer>
